...
export default function Portfolio() {
  ...
  const experiences = [
    {
      ...
      description:
        "Working on fullstack E-government systems, Frontend developer on Qetero Booking System, Full stack developer on Sheger Entrepreneurs Association System",
      current: true,
    },
    {
      title: "Web Developer",
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ["React", "Redux", ".NET", "Ant Design", "SQL Server"],
    ...
    },
    {
      ...
      description:
        "Full-stack booking platform for Cheche Technologies, providing seamless reservation management and user experience.",
    ...
    },
    {
      ...
      description:
        "E-government system for entrepreneur association management with comprehensive member and event management features.",
      tech: ["React", "Node.js", "PostgreSQL", "Redux Toolkit", "Tailwind"],
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h1 className="text-6xl lg:text-7xl font-bold text-[#2C2C2C] leading-tight">
                  Million
                  <span className="block bg-gradient-to-r from-[#2979FF] to-[#00796B] bg-clip-text text-transparent">
                    Tenkir
                  </span>
                </h1>
                <h2 className="text-2xl lg:text-3xl text-[#3A3A3A] font-medium leading-relaxed">
                  Full Stack Developer & DevOps Engineer
                </h2>
                <p className="text-xl text-[#5A5A5A] leading-relaxed max-w-2xl">
                  Passionate Web Developer crafting digital experiences with
                  cutting-edge technologies. Specializing in MERN stack and
              ...
              {[
                ...
                >
                  <CardContent className="p-8 text-center">
                    ...
                    <h3 className="font-bold text-[#2C2C2C] mb-2 text-lg">
                      {title}
                    </h3>
                    <p className="text-[#5A5A5A]">{subtitle}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
                ...
                <CardHeader className="pb-4">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div className="space-y-2">
                      <CardTitle className="text-2xl text-[#2C2C2C] flex items-center gap-3">
                        {exp.title}
                        {exp.current && (
                      ...
                      <CardDescription className="text-[#2979FF] font-semibold text-xl">
                        {exp.company}
                      </CardDescription>
                    </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                >
                  <CardHeader>
                    <CardTitle className="text-[#2C2C2C] flex items-center gap-3 text-xl">
                      <Icon className="h-6 w-6 text-[#2979FF]" />
                      {title}
                    </CardTitle>
                    <CardDescription className="text-[#2979FF] font-semibold text-lg">
                      {institution}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-[#5A5A5A] font-medium">{details}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Card className="bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg shadow-black/5 hover:shadow-xl hover:shadow-[#2979FF]/10 transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
              ...
              <CardHeader>
                <CardTitle className="flex items-center gap-3 text-2xl text-[#2C2C2C]">
                  <Code className="h-6 w-6 text-[#2979FF]" />
                  Frontend Development
                </CardTitle>
                <CardDescription className="text-[#5A5A5A] text-lg">
                ...
                .map((project, index) => (
                  ...
                  >
                    ...
                    <CardHeader>
                      ...
                      <CardDescription className="text-[#5A5A5A] leading-relaxed">
                        {project.description}
                      </CardDescription>
                    </CardHeader>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="bg-white/60 backdrop-blur-xl border border-white/30 shadow-xl shadow-black/5">
              <CardHeader>
                <CardTitle className="text-[#2C2C2C] text-2xl">
                  Contact Information
                </CardTitle>
              </CardHeader>
                  ...
                  <div key={index} className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      {href ? (
                        <a
                          href={href}
                          className="text-[#5A5A5A] hover:text-[#2979FF] transition-colors duration-300 flex items-center gap-2"
                          target={
                        ...
                        <p className="text-[#5A5A5A]">{value}</p>
                      )}
                    </div>
                  </div>
                ))}
      ...
      <footer className="bg-gradient-to-r from-[#2C2C2C] to-[#3A3A3A] text-white py-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-white to-[#C0C0C0] bg-clip-text text-transparent">
              Million Tenkir
            </h3>
